...
(function (MAP_CTF, $, undefined) {
  ...
  MAP_CTF.gameboard = (function () {
     ...
     */
    function loadMap() {
      var mapPath = "svg/map/worldLow.svg";
   ...
   * --slider
   */
  MAP_CTF.slider = (function () {
    var selector = ".mctf-slider";
     ...
     */
    function init(cb) {
      var itemWidth = $(selector).closest("#mctf-modal").length > 0 ? 90 : 120;

      $(selector).flexslider({
        namespace: "mctf-slider-",
        animation: "slide",
        selector: ".slides > li",
        slideshow: false,
        minItems: 2,
  ...
  MAP_CTF.init = function () {
    ...
    //
    MAP_CTF.loadComponent("#mctf-svg-sprite", "svg/icons/icons.svg");
